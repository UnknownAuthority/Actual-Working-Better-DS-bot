...
class Misc(commands.Cog):
  ...
  async def on_member_join(self, member):
     ...
     embed = discord.Embed(title=f"{member.name} has joined the server!",description=f"{member.mention} thank you for the server!, please read the rules and follow them here!",color=0x001eff)
